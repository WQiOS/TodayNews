...
class AdvertiseViewController: UIViewController {
    ...
    @IBOutlet var advertiseImageView: UIImageView!
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = UIColor.white
        
        countdownTimer = Timer.scheduledTimer(timeInterval: time, target: self, selector: #selector(updateTime), userInfo: nil, repeats: true)
        timeButton.backgroundColor = UIColor.red
        advertiseImageView.kf.setImage(with: URL(string:"https://ns-image.oss-cn-hangzhou.aliyuncs.com/UserImagePic/201607/20160724171524_7680.jpg"))
    }
